...
var shaderResources;
var models = ['FOTSPromo.json'];
var modelResources;
var textures = ['FOTSPromoTex.png'];
...
var setTransformationMatrecies = function(gl,program, fov, aspect, clipNear, clipFar) {
	...
	glMatrix.mat4.lookAt(viewMatrix, [5,2,15], [0,0,0], [0,1,0]);
...
var runRenderer = function () {
    ...
    setTransformationMatrecies(gl,program, 40, canvas.clientWidth / canvas.clientHeight, 0.1, 1000.0);
    
    renderObjects = [
        new RenderObject(modelResources[0],initializeTexture(gl,textureResources[0]),program, "promo")
...
//generate json models 'E:\Program Files\assimp2json-2.0-win32\Release' .\\assimp2json.exe 'E:\projects\for old times sake\workfiles\promo3D.fbx' 'D:\GitRepos\github.io\blog\FOTSPromo.json'\